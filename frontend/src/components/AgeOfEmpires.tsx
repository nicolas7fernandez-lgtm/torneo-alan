  ...
  return (
    <div className="space-y-4 p-4">
      ...
      <div className="bg-black/60 backdrop-blur-sm rounded-2xl p-4 space-y-3 border border-green-900/30">
        ...
        <div className="flex justify-around items-center">
          <div className="text-center">
            <div className="text-5xl font-black text-green-400">{data.fechas.nico}</div>
            <div className="text-xs text-green-700 mt-0.5">{data.fechas.nico}/{FECHAS_PER_TORNEO}</div>
          </div>
          <div className="text-green-900 text-3xl font-thin">—</div>
          <div className="text-center">
            <div className="text-5xl font-black text-red-400">{data.fechas.alan}</div>
            <div className="text-xs text-red-900 mt-0.5">{data.fechas.alan}/{FECHAS_PER_TORNEO}</div>
          </div>
        </div>
