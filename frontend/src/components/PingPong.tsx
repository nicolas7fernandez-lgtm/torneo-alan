    ...
    <div className="space-y-4 p-4">
      ...
      <div className="flex gap-3">
        <div className="flex flex-col gap-1 flex-1">
          <button onClick={() => addPoint('nico')} className="w-full py-4 rounded-2xl bg-violet-700 hover:bg-violet-600 text-white font-bold text-lg active:scale-95 transition-transform">+1 Nico</button>
        ...
        <div className="flex flex-col gap-1 flex-1">
          <button onClick={() => addPoint('alan')} className="w-full py-4 rounded-2xl bg-sky-700 hover:bg-sky-600 text-white font-bold text-lg active:scale-95 transition-transform">+1 Alan</button>
